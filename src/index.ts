...
export const items = new Set<Screw>();
...
// interface IScrewFrame extends IKeyframe {
//     screw: Screw;
// }
...
//         Object.assign(this, data); // Not so safe
//     }

//     private _screw: Screw;
//     private _startTime: number;
//     private _endTime: number;

//     private _isBegan = false;
//     begin() {
...
export default class Screw extends EventEmitter {
    ...
    private _update(dt: number) {
        ...
        this.keyframes.forEach((frame) => {
            ...
            // const isTimeBeforeEnd = this.time <= frame._endTime;
